...
class StaticPageTests(TestCase):
    ...
    def test_admin_pages_require_admin_context(self):
        ...
        self.assertIn("admin-console-8", admin_body)
        self.assertIn('id="pointsAdjustModal"', admin_body)
        self.assertIn('data-points-action="adjust"', admin_body)
        self.assertNotIn('id="pointsAdjustUserId"', admin_body)
